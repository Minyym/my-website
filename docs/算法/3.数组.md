...
<img src="https://cdn.jsdelivr.net/gh/Min-wys/figure-bed/img/20220513114857.png" style="zoom:50%;" />

- 从后面开始遍历数组，找到第一个升序子序列

  <img src="https://cdn.jsdelivr.net/gh/Min-wys/figure-bed/img/20220513114945.png" style="zoom:50%;" />

- 在(j,end]中遍历找到刚好大于nums[i]的数，进行位置交换，数是6，和5进行位置交换

  <img src="https://cdn.jsdelivr.net/gh/Min-wys/figure-bed/img/20220513115716.png" style="zoom:50%;" />

- (j,end]现在是降序，将(j,end]改为升序，因此，`123857643` 的下一个排列就是 `123863457`。

  <img src="https://cdn.jsdelivr.net/gh/Min-wys/figure-bed/img/20220513115940.png" style="zoom:50%;" />
...
- 你必须在 原地 旋转图像，这意味着你需要直接修改输入的二维矩阵。请不要 使用另一个矩阵来旋转图像
  ...
  <img src="https://cdn.jsdelivr.net/gh/Min-wys/figure-bed/img/20220513142052.png" style="zoom:50%;" />
...
<img src="https://cdn.jsdelivr.net/gh/Min-wys/figure-bed/img/20220513143359.png" style="zoom:50%;" />
